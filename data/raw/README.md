...
据此显示「图文攻略」「视频攻略」按钮，并始终提供「搜索图文攻略」（默认必应，可在设置中切换百度 /
谷歌）与「搜索视频攻略」（B 站）按钮，内置链接缺失时也能检索到对应条目。
...
设计图沿用同名服装的获取页与视频分 P。战衣视频逐套指向 B 站「126 套纳米服全收集」
（<https://www.bilibili.com/video/BV1Wfj1ztEuj>，每套一个分 P），未收录的少数套装回退到
喂狗组-文轩「服装&外观篇」（BV1or421L7XQ）。
