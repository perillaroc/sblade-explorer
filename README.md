...
- **中文攻略链接**：详情弹窗按「图文攻略 / 视频攻略」打开游民星空图文与 B 站「喂狗组-文轩」
  全收集视频（罐子/鱼类精确到单个物品，记录/密码精确到区域分 P）；缺少链接时回退为必应 / B 站
  搜索。链接数据随程序内置，运行时不联网，点击后由系统浏览器打开。
...
- [游民星空](https://www.gamersky.com/handbook/202404/1738505.shtml)（全收集图文攻略）与
...
- 中文攻略链接：810 条全部至少有一条链接（图文 794、视频 634）；罐子/鱼类逐物品、
  记录/密码按区域分 P，其余按品类或区域；链接均为 https 且域名在白名单内。
